...
export default function ContactFooter() {
  return (
    <section
      id="contact"
      className="bg-gradient-to-tr from-[#0f172a] via-[#0b0c1d] to-[#0f172a] text-starlight pt-20 pb-8 px-6 md:px-16 relative"
    >
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-center text-auroraGreen">
          Let’s Connect 💬
        </h2>
      ...
      <div className="mt-10 text-center">
        ...
        <div className="flex justify-center gap-6 text-2xl text-starlight">
          <a
            ...
            target="_blank"
            className="hover:text-auroraGreen"
          >
            <FaGithub />
          </a>
          <a
        ...
        <div className="pt-3 text-center text-base sm:text-lg text-starlight">
          (+91-8968922155)
        </div>
      </div>
      ...
      <footer className="mt-16 text-center text-starlight/70 text-sm">
        ...
        <p>
          Built with 💖 by{" "}
          <span className="text-auroraGreen font-bold">Rachit Bansal</span> —{" "}
